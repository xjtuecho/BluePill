...
void CEC_Init(CEC_InitPara* CEC_InitParaStruct)
{
    ...
    temp_sr |= (CEC_InitParaStruct->CEC_SFTM     | CEC_InitParaStruct->CEC_RTOL    |
                CEC_InitParaStruct->CEC_RBRESTOP | CEC_InitParaStruct->CEC_RBREGEN |
                CEC_InitParaStruct->CEC_RLBPEGEN | CEC_InitParaStruct->CEC_BCNG    |
                CEC_InitParaStruct->CEC_SFTMOPT);
...
void CEC_ParaInit(CEC_InitPara* CEC_InitParaStruct)
{
    ...
    CEC_InitParaStruct->CEC_SFTM     = CEC_SFTM_STD;
    CEC_InitParaStruct->CEC_RTOL     = CEC_RTOL_STD;
    CEC_InitParaStruct->CEC_RBRESTOP = CEC_RBRESTOP_OFF;
    CEC_InitParaStruct->CEC_RBREGEN  = CEC_RBREGEN_OFF;
    CEC_InitParaStruct->CEC_RLBPEGEN = CEC_RLBPEGEN_OFF;
    CEC_InitParaStruct->CEC_BCNG     = CEC_BCNG_OFF;
    CEC_InitParaStruct->CEC_SFTMOPT  = CEC_SFTMOPT_SOM;
}
...
/**
  ...
  * @param  CEC_INT: specifie the CEC interrupt source. Select one of the follwing values:
  ...
  *     @arg CEC_INT_LSTARB: Arbitration Lost.
  *     @arg CEC_INT_RAE   : Receive Acknowledge Error.
  *     @arg CEC_INT_RLBPE : Rx Long bit period Error.
  *     @arg CEC_INT_RSBPE : Rx Short bit period Error.
  *     @arg CEC_INT_RBRE  : Rx Bit Rising Error.
  *     @arg CEC_INT_RO    : Receive Overrun.
  *     @arg CEC_INT_REND  : Rx End Of Reception.
...
/**
  ...
  * @param  CEC_FLAG: specifie the CEC flag. Select one of the follwing values:
  ...
  *     @arg CEC_FLAG_LSTARB : Arbitration Lost.
  *     @arg CEC_FLAG_RAE    : Receive Acknowledge Error.
  *     @arg CEC_FLAG_RLBPE  : Rx Long bit period Error.
  *     @arg CEC_FLAG_RSBPE  : Rx Short bit period Error.
  *     @arg CEC_FLAG_RBRE   : Rx Bit Rising Error.
  *     @arg CEC_FLAG_RO     : Receive Overrun.
  *     @arg CEC_FLAG_REND   : Rx End Of Reception.
