...
#define INT_MASK                                        ((uint32_t)0x000000FF)   /*!< USART Interrupts mask */


#define CTLR1_CLEAR_MASK                                ((uint32_t)(0X0000160C)) /*!< USART CTLR1 initializes bit mask */


#define CTLR2_CLOCK_CLEAR_MASK                          ((uint32_t)(0x00000F00)) /*!< USART CTLR2 CLOCK initializes bit mask */


#define CTLR3_CLEAR_MASK                                ((uint32_t)(0x00000300)) /*!< USART CTLR3 CLOCK initializes bit mask */
...
/**
  ...
  * @param  USARTx: the USART peripheral where x can be 1 or 2.
  * @param  USART_OVRD: USART_OVRDETECTION_ENABLE,USART_OVRDETECTION_DISABLE
            the OVRD bit state in case of Overrun error.
  * @retval None
  */
