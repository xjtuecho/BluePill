...
void TSI_DeInit( void )
{
    ...
    RCC_AHBPeriphReset_Enable(RCC_AHBPERIPH_TSIRST, ENABLE);
    /* Release TSI from reset state */
    RCC_AHBPeriphReset_Enable(RCC_AHBPERIPH_TSIRST, DISABLE);
}
...
/**
  ...
  * @param  TSI_INT: Specifie TSI interrupt sources. 
  *   This parameter can be the following values:
  *     @arg TSI_IER_CRCFIE: End of acquisition interrupt mask 
  *     @arg TSI_IER_MNEIE : Max Cycle Number Error interrupt mask
  * @param  NewValue: ENABLE or DISABLE.
  * @retval None
  */
...
/**
  ...
  * @param  TSI_INT: Specifie TSI interrupt sources. 
  *   This parameter can be the following values:
  *     @arg TSI_CEFR_CMNE : Max Cycle Number Error interrupt 
...
/**
  ...
  *   This parameter can be the following values:
  *     @arg TSI_STR_CTCF: End of acquisition interrupt 
  *     @arg TSI_STR_MNE : Max Cycle Number Error interrupt 
