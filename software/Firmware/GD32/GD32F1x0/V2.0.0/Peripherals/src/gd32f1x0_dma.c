...
#define CTLRx_CLEAR_MASK                    ((uint32_t)0xFFFF800F) /*!< DMA Channel config registers Masks */

#define  DMA_REGISTERS_RESET                ((uint32_t)0x00000000) /*!< DMA Reset registers mask */

#define  DMA_INIT_RESET                     ((uint32_t)0x00000000) /*!< DMA Init Reset mask */

#define DMA1_CHANNEL1_INT_MASK              ((uint32_t)(DMA_IFR_GIF1 | DMA_IFR_TCIF1 | DMA_IFR_HTIF1 | DMA_IFR_ERRIF1)) /*!< DMA1 Channel1 interrupt  bit masks */
#define DMA1_CHANNEL2_INT_MASK              ((uint32_t)(DMA_IFR_GIF2 | DMA_IFR_TCIF2 | DMA_IFR_HTIF2 | DMA_IFR_ERRIF2)) /*!< DMA1 Channel2 interrupt  bit masks */
#define DMA1_CHANNEL3_INT_MASK              ((uint32_t)(DMA_IFR_GIF3 | DMA_IFR_TCIF3 | DMA_IFR_HTIF3 | DMA_IFR_ERRIF3)) /*!< DMA1 Channel3 interrupt  bit masks */
#define DMA1_CHANNEL4_INT_MASK              ((uint32_t)(DMA_IFR_GIF4 | DMA_IFR_TCIF4 | DMA_IFR_HTIF4 | DMA_IFR_ERRIF4)) /*!< DMA1 Channel4 interrupt  bit masks */
#define DMA1_CHANNEL5_INT_MASK              ((uint32_t)(DMA_IFR_GIF5 | DMA_IFR_TCIF5 | DMA_IFR_HTIF5 | DMA_IFR_ERRIF5)) /*!< DMA1 Channel5 interrupt  bit masks */
#define DMA1_CHANNEL6_INT_MASK              ((uint32_t)(DMA_IFR_GIF6 | DMA_IFR_TCIF6 | DMA_IFR_HTIF6 | DMA_IFR_ERRIF6)) /*!< DMA1 Channel6 interrupt  bit masks */
#define DMA1_CHANNEL7_INT_MASK              ((uint32_t)(DMA_IFR_GIF7 | DMA_IFR_TCIF7 | DMA_IFR_HTIF7 | DMA_IFR_ERRIF7)) /*!< DMA1 Channel7 interrupt  bit masks */
