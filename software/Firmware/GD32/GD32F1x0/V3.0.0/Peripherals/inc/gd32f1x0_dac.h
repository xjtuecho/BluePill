...
#define DAC_CTL                 REG32(DAC + 0x00)  /*!< DAC control register */
#define DAC_SWT                 REG32(DAC + 0x04)  /*!< DAC software trigger register */
#define DAC0_R12DH              REG32(DAC + 0x08)  /*!< DAC0 12-bit right-aligned data holding register */
#define DAC0_L12DH              REG32(DAC + 0x0C)  /*!< DAC0 12-bit left-aligned data holding register */
#define DAC0_R8DH               REG32(DAC + 0x10)  /*!< DAC0 8-bit right-aligned data holding register */
#ifdef GD32F170_190
#define DAC1_R12DH              REG32(DAC + 0x14)  /*!< DAC1 12-bit right-aligned data holding register */
#define DAC1_L12DH              REG32(DAC + 0x18)  /*!< DAC1 12-bit left-aligned data holding register */
#define DAC1_R8DH               REG32(DAC + 0x1C)  /*!< DAC1 8-bit right-aligned data holding register */
#define DACC_R12DH              REG32(DAC + 0x20)  /*!< DAC concurrent mode 12-bit right-aligned data holding register */
#define DACC_L12DH              REG32(DAC + 0x24)  /*!< DAC concurrent mode 12-bit left-aligned data holding register */
#define DACC_R8DH               REG32(DAC + 0x28)  /*!< DAC concurrent mode 8-bit right-aligned data holding register */
#endif  /* GD32F170_190 */
#define DAC0_DO                 REG32(DAC + 0x2C)  /*!< DAC0 output data register */
#ifdef GD32F170_190
#define DAC1_DO                 REG32(DAC + 0x30)  /*!< DAC1 output data register */
#endif  /* GD32F170_190 */
#define DAC_STAT                REG32(DAC + 0x34)  /*!< DAC status register */
...
/* dac trigger source */
#define CTL_DTSEL(regval)       (BITS(3,5) & ((regval) << 3))
#define DAC_TRIGGER_T5_TRGO     CTL_DTSEL(0)       /*!< TIMER5 TRGO */
#define DAC_TRIGGER_T2_TRGO     CTL_DTSEL(1)       /*!< TIMER3 TRGO */
#define DAC_TRIGGER_T14_TRGO    CTL_DTSEL(3)       /*!< TIMER15 TRGO */
#define DAC_TRIGGER_T1_TRGO     CTL_DTSEL(4)       /*!< TIMER1 TRGO */
#define DAC_TRIGGER_EXTI_IT9    CTL_DTSEL(6)       /*!< EXTI interrupt line9 event */
#define DAC_TRIGGER_SOFTWARE    CTL_DTSEL(7)       /*!< software trigger */

/* dac data alignment */
#define DATA_ALIGN(regval)      (BITS(0,1) & ((regval) << 0))
