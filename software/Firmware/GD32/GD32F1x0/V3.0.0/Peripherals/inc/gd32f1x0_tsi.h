...
#define TSI_CTL                 REG32(TSI + 0x00) /*!< TSI control register */
#define TSI_INTEN               REG32(TSI + 0x04) /*!< TSI interrupt enable register */
#define TSI_INTC                REG32(TSI + 0x08) /*!< TSI interrupt flag clear register */
#define TSI_INTF                REG32(TSI + 0x0C) /*!< TSI interrupt flag register */
#define TSI_PHM                 REG32(TSI + 0x10) /*!< TSI pin hysteresis mode register */
#define TSI_ASW                 REG32(TSI + 0x18) /*!< TSI analog switch register */
#define TSI_SAMPCFG             REG32(TSI + 0x20) /*!< TSI sample configuration register */
#define TSI_CHCFG               REG32(TSI + 0x28) /*!< TSI channel configuration register */
#define TSI_GCTL                REG32(TSI + 0x30) /*!< TSI group control register */
#define TSI_G0CYCN              REG32(TSI + 0x34) /*!< TSI group 0 cycle number register */
#define TSI_G1CYCN              REG32(TSI + 0x38) /*!< TSI group 1 cycle number register */
#define TSI_G2CYCN              REG32(TSI + 0x3C) /*!< TSI group 2 cycle number register */
#define TSI_G3CYCN              REG32(TSI + 0x40) /*!< TSI group 3 cycle number register */
#define TSI_G4CYCN              REG32(TSI + 0x44) /*!< TSI group 4 cycle number register */
#define TSI_G5CYCN              REG32(TSI + 0x48) /*!< TSI group 5 cycle number register */
...
#define CTL_CTCDIV(regval)      (BITS(12,14) & (regval << 12)) /*!< CTCLK clock division factor */
...
#define CTL_CTDT(regval)        (BITS(24,27) & (regval << 24)) /*!< charge transfer state duration time */
...
#define CTL_CDT(regval)         (BITS(28,31) & ((uint32_t)regval << 28)) /*!< charge state duration time */
...
#define CTL_MCN(regval)         (BITS(5,7) & (regval << 5)) /*!< max cycle number of a sequence */
...
#define TSI_EXTEND_DIV1         0x00 /*!< fECCLK = fHCLK */
#define TSI_EXTEND_DIV2         0x01 /*!< fECCLK = fHCLK/2 */

/* Extend Charge State Maximum Duration Time */
#define TSI_EXTENDMAX(regval)       (BITS(17,23) & ((regval) << 17)) /* value range 1...128,extend charge state maximum duration time */

/* hardware trigger mode */
#define TSI_FALLING_TRIGGER     0x00 /*!< falling edge trigger TSI charge transfer sequence */
#define TSI_RISING_TRIGGER      0x01 /*!< rising edge trigger TSI charge transfer sequence */

/* pin mode */
#define TSI_OUTPUT_LOW          0x00 /*!< TSI pin will output low when IDLE */
#define TSI_INPUT_FLOATING      0x01 /*!< TSI pin will keep input_floating when IDLE */
