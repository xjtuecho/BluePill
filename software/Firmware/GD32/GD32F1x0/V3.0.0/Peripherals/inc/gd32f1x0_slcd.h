...
#define SLCD_CTL                        REG32(SLCD + 0x00)                  /*!< SLCD controller register */
#define SLCD_CFG                        REG32(SLCD + 0x04)                  /*!< SLCD configuration register */
#define SLCD_STAT                       REG32(SLCD + 0x08)                  /*!< SLCD status flag register */
#define SLCD_STATC                      REG32(SLCD + 0x0C)                  /*!< SLCD status flag clear register */
#define SLCD_DATA0                      REG32(SLCD + 0x14)                  /*!< SLCD display data register 0 */
#define SLCD_DATA1                      REG32(SLCD + 0x1C)                  /*!< SLCD display data register 1 */
#define SLCD_DATA2                      REG32(SLCD + 0x24)                  /*!< SLCD display data register 2 */
#define SLCD_DATA3                      REG32(SLCD + 0x2C)                  /*!< SLCD display data register 3 */
#define SLCD_DATA4                      REG32(SLCD + 0x34)                  /*!< SLCD display data register 4 */
#define SLCD_DATA5                      REG32(SLCD + 0x3C)                  /*!< SLCD display data register 5 */
#define SLCD_DATA6                      REG32(SLCD + 0x44)                  /*!< SLCD display data register 6 */
#define SLCD_DATA7                      REG32(SLCD + 0x4C)                  /*!< SLCD display data register 7 */
...
/* status flag */
#define SLCD_FLAG_ONF                   SLCD_STAT_ONF                       /*!< SLCD controller on flag */
#define SLCD_FLAG_SOF                   SLCD_STAT_SOF                       /*!< start of frame flag */
#define SLCD_FLAG_UPRF                  SLCD_STAT_UPRF                      /*!< SLCD data update request flag */
#define SLCD_FLAG_UPDF                  SLCD_STAT_UPDF                      /*!< update data done flag */
#define SLCD_FLAG_VRDYF                 SLCD_STAT_VRDYF                     /*!< SLCD voltage ready flag */
#define SLCD_FLAG_SYNF                  SLCD_STAT_SYNF                      /*!< SLCD register synchronization flag */

/* interrupt flag */
#define SLCD_INT_SOF                    ((uint8_t)0x00)                     /*!< start of frame interrupt */
#define SLCD_INT_UPD                    ((uint8_t)0x01)                     /*!< update data done interrupt */

/* voltage source definitions */
#define SLCD_VOLTAGE_INTERNAL           ((uint8_t)0x00)                     /*!< SLCD internal voltage source */
#define SLCD_VOLTAGE_EXTERNAL           ((uint8_t)0x01)                     /*!< SLCD external voltage source */

/* data register definitions */
#define SLCD_DATA_REG0                  ((uint32_t)0x00000000)              /*!< SLCD display data register 0 */
#define SLCD_DATA_REG1                  ((uint32_t)0x00000002)              /*!< SLCD display data register 1 */
#define SLCD_DATA_REG2                  ((uint32_t)0x00000004)              /*!< SLCD display data register 2 */
#define SLCD_DATA_REG3                  ((uint32_t)0x00000006)              /*!< SLCD display data register 3 */
#define SLCD_DATA_REG4                  ((uint32_t)0x00000008)              /*!< SLCD display data register 4 */
#define SLCD_DATA_REG5                  ((uint32_t)0x0000000A)              /*!< SLCD display data register 5 */
#define SLCD_DATA_REG6                  ((uint32_t)0x0000000C)              /*!< SLCD display data register 6 */
#define SLCD_DATA_REG7                  ((uint32_t)0x0000000E)              /*!< SLCD display data register 7 */

/* bias voltage definitions */
#define CTL_BIAS(regval)                (BITS(5,6) & ((regval) << 5))
...
#define CTL_DUTY(regval)                (BITS(2,4) & ((regval) << 2))
...
#define CFG_PRE(regval)                 (BITS(22,25) & ((regval) << 22))
...
/* SLCD clock divider */
#define CFG_DIV(regval)                 (BITS(18,21) & ((regval) << 18))    
...
/* SLCD blink mode */
#define CFG_BLKM(regval)                (BITS(16,17) & ((regval) << 16))
...
#define CFG_BLKDIV(regval)              (BITS(13,15) & ((regval) << 13))
...
/* SLCD Contrast ratio */
#define CFG_CONR(regval)                (BITS(10,12) & ((regval) << 10))
...
/* dead time duration */
#define CFG_DD(regval)                  (BITS(7,9) & ((regval) << 7))
...
/* pulse on duration */
#define CFG_PULSE(regval)               (BITS(4,6) & ((regval) << 4))
