...
#define OPA_CTL                 REG32(OPA + 0x00)      /*!< OPA control register */
#define OPA_BT                  REG32(OPA + 0x04)      /*!< OPA bias trimming register for normal mode */
#define OPA_LPBT                REG32(OPA + 0x08)      /*!< OPA bias trimming register for low power mode */
