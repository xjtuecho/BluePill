...
#define TIMER0                           (TIMER_BASE + 0x00012C00)
#define TIMER1                           (TIMER_BASE + 0x00000000)
#define TIMER2                           (TIMER_BASE + 0x00000400)
#define TIMER5                           (TIMER_BASE + 0x00001000)
#define TIMER13                          (TIMER_BASE + 0x00002000)
#define TIMER14                          (TIMER_BASE + 0x00014000)
#define TIMER15                          (TIMER_BASE + 0x00014400)
#define TIMER16                          (TIMER_BASE + 0x00014800)

/* registers definitions */
#define TIMER_CTL0(timerx)               REG32((timerx) + 0x00)           /*!< TIMER control register 0 */
#define TIMER_CTL1(timerx)               REG32((timerx) + 0x04)           /*!< TIMER control register 1 */
#define TIMER_SMCFG(timerx)              REG32((timerx) + 0x08)           /*!< TIMER slave mode configuration register */
#define TIMER_DMAINTEN(timerx)           REG32((timerx) + 0x0C)           /*!< TIMER DMA and interrupt enable register */
#define TIMER_INTF(timerx)               REG32((timerx) + 0x10)           /*!< TIMER interrupt flag register */
#define TIMER_SWEVG(timerx)              REG32((timerx) + 0x14)           /*!< TIMER software event generation register */
#define TIMER_CHCTL0(timerx)             REG32((timerx) + 0x18)           /*!< TIMER channel control register 0 */
#define TIMER_CHCTL1(timerx)             REG32((timerx) + 0x1C)           /*!< TIMER channel control register 1 */
#define TIMER_CHCTL2(timerx)             REG32((timerx) + 0x20)           /*!< TIMER channel control register 2 */
#define TIMER_CNT(timerx)                REG32((timerx) + 0x24)           /*!< TIMER counter register */
#define TIMER_PSC(timerx)                REG32((timerx) + 0x28)           /*!< TIMER prescaler register */
#define TIMER_CAR(timerx)                REG32((timerx) + 0x2C)           /*!< TIMER counter auto reload register */
#define TIMER_CREP(timerx)               REG32((timerx) + 0x30)           /*!< TIMER counter repetition register */
#define TIMER_CH0CV(timerx)              REG32((timerx) + 0x34)           /*!< TIMER channel 0 capture/compare value register */
#define TIMER_CH1CV(timerx)              REG32((timerx) + 0x38)           /*!< TIMER channel 1 capture/compare value register */
#define TIMER_CH2CV(timerx)              REG32((timerx) + 0x3C)           /*!< TIMER channel 2 capture/compare value register */
#define TIMER_CH3CV(timerx)              REG32((timerx) + 0x40)           /*!< TIMER channel 3 capture/compare value register */
#define TIMER_CCHP(timerx)               REG32((timerx) + 0x44)           /*!< TIMER complementary channel protection register */
#define TIMER_DMACFG(timerx)             REG32((timerx) + 0x48)           /*!< TIMER DMA configuration register */
#define TIMER_DMATB(timerx)              REG32((timerx) + 0x4C)           /*!< TIMER DMA transfer buffer register */
#define TIMER_IRMP(timerx)               REG32((timerx) + 0x50)           /*!< TIMER channel input remap register */
#define TIMER_CFG(timerx)                REG32((timerx) + 0xFC)           /*!< TIMER configuration register */
...
#define TIMER_SMCFG_SMC1                 BIT(14)             /*!< part of SMC for enable external clock mode1 */
...
#define TIMER_CHCTL2_CH1NP               BIT(7)              /*!< channel 0 complementary output polarity */
...
#define TIMER_CHCTL2_CH2NP               BIT(11)             /*!< channel 0 complementary output polarity */
...
/* TIMER_CAR */
#define TIMER_CAR_CAR                    BITS(0,15)          /*!< counter auto reload value */

/* TIMER_CREP */
#define TIMER_CREP_CREP                  BITS(0,7)           /*!< counter repetition value */

/* TIMER_CH0CV */
#define TIMER_CH0CV_CH0VAL               BITS(0,15)          /*!< capture/compare value of channel0 */

/* TIMER_CH1CV */
#define TIMER_CH1CV_CH1VAL               BITS(0,15)          /*!< capture/compare value of channel1 */

/* TIMER_CH2CV */
#define TIMER_CH2CV_CH2VAL               BITS(0,15)          /*!< capture/compare value of channel2 */

/* TIMER_CH3CV */
#define TIMER_CH3CV_CH3VAL               BITS(0,15)          /*!< capture/compare value of channel3 */
...
/* TIMER_DMACFG */
#define TIMER_DMACFG_DMATA               BITS(0,4)           /*!< DMA access base address */
#define TIMER_DMACFG_DMATC               BITS(8,12)          /*!< DMA access burst length */
...
#define TIMER_CFG_CCSEL                  BIT(1)              /*!< write CC register selection */
...
typedef struct
{ 
    uint16_t timer_prescaler;                         /*!< prescaler value */
    uint16_t timer_alignedmode;                       /*!< aligned mode */
    uint16_t timer_counterdirection;                  /*!< counter direction */
    uint32_t timer_period;                            /*!< period value */
    uint16_t timer_clockdivision;                     /*!< clock division value */
    uint8_t  timer_repetitioncounter;                 /*!< the counter repetition value */
}timer_parameter_struct;

/* break parameter struct definitions*/
typedef struct
{ 
    uint16_t timer_rosstate;                          /*!< run mode off-state */
    uint32_t timer_iosstate;                          /*!< idle mode off-state */
    uint16_t timer_deadtime;                          /*!< delay time between the switching off and on of the outputs */
    uint16_t timer_breakpolarity;                     /*!< break polarity */
    uint16_t timer_outauto;                           /*!< output automatic enable */
    uint16_t timer_protmode;                          /*!< complementary register protect control */
    uint16_t timer_state;                             /*!< break enable */
}timer_break_parameter_struct;

/* channel output parameter struct definitions */
typedef struct
{ 
    uint32_t timer_outputstate;                       /*!< channel output state */
    uint16_t timer_outputnstate;                      /*!< channel complementary output state */
    uint16_t timer_ocpolarity;                        /*!< channel output polarity */
    uint16_t timer_ocnpolarity;                       /*!< channel complementary output polarity */
    uint16_t timer_ocidlestate;                       /*!< idle state of channel output */
    uint16_t timer_ocnidlestate;                      /*!< idle state of channel complementary output */
}timer_oc_parameter_struct;

/* channel input parameter struct definitions */
typedef struct
{ 
    uint16_t timer_icpolarity;                        /*!< channel input polarity */
    uint16_t timer_icselection;                       /*!< channel input mode selection */
    uint16_t timer_icprescaler;                       /*!< channel input capture prescaler */
    uint16_t timer_icfilter;                          /*!< channel input capture filter control */
}timer_ic_parameter_struct;


/* TIMER channel y(y=0,1,2,3) */
#define TIMER_CH_0                          ((uint16_t)0x0000)                      /*!< TIMER channel0(TIMERx(x=0,1,2,13,14,15,16)) */
#define TIMER_CH_1                          ((uint16_t)0x0001)                      /*!< TIMER channel1(TIMERx(x=0,1,2,14)) */
#define TIMER_CH_2                          ((uint16_t)0x0002)                      /*!< TIMER channel2(TIMERx(x=0,1,2)) */
#define TIMER_CH_3                          ((uint16_t)0x0003)                      /*!< TIMER channel3(TIMERx(x=0,1,2)) */

/* specify division ratio between TIMER clock and dead-time and sampling clock */
#define CTL0_CKDIV(regval)                  (BITS(8, 9) & ((regval) << 8))
#define TIMER_CKDIV_DIV1                    CTL0_CKDIV(0)                            /*!< clock division value is 1 */
#define TIMER_CKDIV_DIV2                    CTL0_CKDIV(1)                            /*!< clock division value is 2 */
#define TIMER_CKDIV_DIV4                    CTL0_CKDIV(2)                            /*!< clock division value is 4 */

/* center-aligned mode selection */
#define CTL0_CAM(regval)                    (BITS(5, 6) & ((regval) << 5))
...
/* count direction */
#define TIMER_COUNTER_UP                    ((uint16_t)0x0000)                      /*!< counter up direction */
#define TIMER_COUNTER_DOWN                  ((uint16_t)0x0010)                      /*!< counter down direction */

/* single pulse mode */
#define TIMER_SP_MODE_SINGLE                TIMER_CTL0_SPM                          /*!< single pulse mode */
#define TIMER_SP_MODE_REPETITIVE            ((uint16_t)0x0000)                      /*!< repetitive pulse mode */
...
#define TIMER_UPDATE_SRC_GLOBAL             ~TIMER_CTL0_UPS                         /*!< update generate by setting of UPG bit or the counter overflow/underflow,or the slave mode controller trigger */
...
/* master mode control */
#define CTL1_MMC(regval)                    (BITS(4, 6) & ((regval) << 4))
...
#define TIMER_TRI_OUT_SRC_OC0               CTL1_MMC(3)                             /*!< OC0 as trigger output */
...
#define TIMER_HALLINTERFACE_DISABLE         ~TIMER_CTL1_TI0S                        /*!< TIMER hall sensor mode disable */

/* channel DMA request source selection */ 
#define TIMER_DMAREQUEST_UPDATEEVENT        TIMER_CTL1_DMAS                         /*!< DMA request of channely is sent when update event occurs */
#define TIMER_DMAREQUEST_CHANNELEVENT       ~TIMER_CTL1_DMAS                        /*!< DMA request of channel y is sent when channel y event occurs */

/* channel control shadow register update control */ 
#define TIMER_UPDATECTL_CCU                 TIMER_CTL1_CCUC                         /*!< the shadow registers update by when CMTG bit is set */
#define TIMER_UPDATECTL_CCUTRI              ((uint16_t)0x0000)                      /*!< the shadow registers update by when CMTG bit is set or an rising edge of TRGI occurs */
...
#define TIMER_OCN_IDLE_STATE_HIGH           ((uint16_t)0x0200)                      /*!< idle state of channel complementary output is high */
#define TIMER_OCN_IDLE_STATE_LOW            ((uint16_t)0x0000)                      /*!< idle state of channel complementary output is low */

/* master slave mode selection */ 
#define TIMER_MASTER_SLAVE_MODE_ENABLE      TIMER_SMCFG_MSM                         /*!< master slave mode enable */
#define TIMER_MASTER_SLAVE_MODE_DISABLE     ~TIMER_SMCFG_MSM                        /*!< master slave mode disable */

/* slave mode control */
#define SMCFG_SMC(regval)                   (BITS(0, 2) & ((regval) << 0)) 
...
/* trigger selection */
#define SMCFG_TRGS(regval)                  (BITS(4, 6) & ((regval) << 4))
#define TIMER_SMCFG_TRGS_ITI0               SMCFG_TRGS(0)                           /*!< internal trigger 0 */
#define TIMER_SMCFG_TRGS_ITI1               SMCFG_TRGS(1)                           /*!< internal trigger 1 */
#define TIMER_SMCFG_TRGS_ITI2               SMCFG_TRGS(2)                           /*!< internal trigger 2 */
#define TIMER_SMCFG_TRGS_ITI3               SMCFG_TRGS(3)                           /*!< internal trigger 3 */
#define TIMER_SMCFG_TRGS_CI0F_ED            SMCFG_TRGS(4)                           /*!< TI0 Edge Detector */
#define TIMER_SMCFG_TRGS_CI0FE0             SMCFG_TRGS(5)                           /*!< filtered TIMER input 0 */
#define TIMER_SMCFG_TRGS_CI1FE1             SMCFG_TRGS(6)                           /*!< filtered TIMER input 1 */
#define TIMER_SMCFG_TRGS_ETIF               SMCFG_TRGS(7)                           /*!< external trigger */

/* OCPRE clear source selection */
#define TIMER_OCPRE_CLEAR_ETIF              ((uint16_t)0x0008)                      /*!< the internal OCreference clear input is connected to ETIF */
#define TIMER_OCPRE_CLEAR_OCPRECLR          ((uint16_t)0x0000)                      /*!< the internal OCreference clear input is connected to OCPRE_CLR input */

/* external trigger prescaler */
#define SMCFG_ETPSC(regval)                 (BITS(12, 13) & ((regval) << 12))
...
#define TIMER_SMC1_ENABLE                   TIMER_SMCFG_SMC1                        /*!< part of SMC for enable external clock mode1 enable */
#define TIMER_SMC1_DISABLE                  ~TIMER_SMCFG_SMC1                       /*!< part of SMC for enable external clock mode1 disable */
...
#define TIMER_DMA_UPDEN                     ((uint16_t)0x0100)                      /*!< update DMA enable */
#define TIMER_DMA_CH0DEN                    ((uint16_t)0x0200)                      /*!< channel 0 DMA enable */
#define TIMER_DMA_CH1DEN                    ((uint16_t)0x0400)                      /*!< channel 1 DMA enable */
#define TIMER_DMA_CH2DEN                    ((uint16_t)0x0800)                      /*!< channel 2 DMA enable */
#define TIMER_DMA_CH3DEN                    ((uint16_t)0x1000)                      /*!< channel 3 DMA enable */
#define TIMER_DMA_CCUDEN                    ((uint16_t)0x2000)                      /*!< channel control update DMA enable */
#define TIMER_DMA_TRGDEN                    ((uint16_t)0x4000)                      /*!< trigger DMA enable */

/* TIMER interrupt source enable */
#define TIMER_INT_UPIE                      ((uint16_t)0x0001)                      /*!< update interrupt enable */
#define TIMER_INT_CH0IE                     ((uint16_t)0x0002)                      /*!< channel 0 interrupt enable */
#define TIMER_INT_CH1IE                     ((uint16_t)0x0004)                      /*!< channel 1 interrupt enable */
#define TIMER_INT_CH2IE                     ((uint16_t)0x0008)                      /*!< channel 2 interrupt enable */
#define TIMER_INT_CH3IE                     ((uint16_t)0x0010)                      /*!< channel 3 interrupt enable */
#define TIMER_INT_CMTIE                     ((uint16_t)0x0020)                      /*!< commutation DMA request enable */
#define TIMER_INT_TRGIE                     ((uint16_t)0x0040)                      /*!< trigger interrupt enable */
#define TIMER_INT_BRKIE                     ((uint16_t)0x0080)                      /*!< break interrupt enable */

/* TIMER interrupt source */
#define TIMER_INT_UP                        ((uint16_t)0x0001)                      /*!< update interrupt */
#define TIMER_INT_CH0                       ((uint16_t)0x0002)                      /*!< channel 0 interrupt */
#define TIMER_INT_CH1                       ((uint16_t)0x0004)                      /*!< channel 1 interrupt */
#define TIMER_INT_CH2                       ((uint16_t)0x0008)                      /*!< channel 2 interrupt */
#define TIMER_INT_CH3                       ((uint16_t)0x0010)                      /*!< channel 3 interrupt */
#define TIMER_INT_CCU                       ((uint16_t)0x0020)                      /*!< channel control update interrupt */
#define TIMER_INT_TRG                       ((uint16_t)0x0040)                      /*!< trigger interrupt */
#define TIMER_INT_BRK                       ((uint16_t)0x0080)                      /*!< break interrupt */

/* TIMER flag */
#define TIMER_FLAG_UPIF                     ((uint16_t)0x0001)                      /*!< update flag */
#define TIMER_FLAG_CH0IF                    ((uint16_t)0x0002)                      /*!< channel 0 flag */
#define TIMER_FLAG_CH1IF                    ((uint16_t)0x0004)                      /*!< channel 1 flag */
#define TIMER_FLAG_CH2IF                    ((uint16_t)0x0008)                      /*!< channel 2 flag */
#define TIMER_FLAG_CH3IF                    ((uint16_t)0x0010)                      /*!< channel 3 flag */
#define TIMER_FLAG_CMTIF                    ((uint16_t)0x0020)                      /*!< channel control update flag */
#define TIMER_FLAG_TRGIF                    ((uint16_t)0x0040)                      /*!< trigger flag */
#define TIMER_FLAG_BRKIF                    ((uint16_t)0x0080)                      /*!< break flag */
#define TIMER_FLAG_CH0OF                    ((uint16_t)0x0200)                      /*!< channel 0 overcapture flag */
#define TIMER_FLAG_CH1OF                    ((uint16_t)0x0400)                      /*!< channel 1 overcapture flag */
#define TIMER_FLAG_CH2OF                    ((uint16_t)0x0800)                      /*!< channel 2 overcapture flag */
#define TIMER_FLAG_CH3OF                    ((uint16_t)0x1000)                      /*!< channel 3 overcapture flag */

/* TIMER software event generation source */
#define TIMER_EVENT_SRC_UPG                 ((uint16_t)0x0001)                      /*!< update event */
#define TIMER_EVENT_SRC_CH0G                ((uint16_t)0x0002)                      /*!< channel 0 capture or compare event */
#define TIMER_EVENT_SRC_CH1G                ((uint16_t)0x0004)                      /*!< channel 1 capture or compare event */
#define TIMER_EVENT_SRC_CH2G                ((uint16_t)0x0008)                      /*!< channel 2 capture or compare event */
#define TIMER_EVENT_SRC_CH3G                ((uint16_t)0x0010)                      /*!< channel 3 capture or compare event */
#define TIMER_EVENT_SRC_CMTG                ((uint16_t)0x0020)                      /*!< channel commutation event  */
#define TIMER_EVENT_SRC_TRGG                ((uint16_t)0x0040)                      /*!< trigger event */
#define TIMER_EVENT_SRC_BRKG                ((uint16_t)0x0080)                      /*!< break event */

/* TIMER prescaler reload mode */
#define TIMER_PSC_RELOAD_NOW                TIMER_SWEVG_UPG                         /*!< the prescaler is loaded right now */
#define TIMER_PSC_RELOAD_UPDATE             ((uint16_t)0x0000)                      /*!< the prescaler is loaded at the next update event */

/* TIMER input capture selection */
#define TIMER_IC_SELECTION_DIRECTTI         ((uint16_t)0x0001)                      /*!< channel y is configured as input and icy is mapped on TIy */
#define TIMER_IC_SELECTION_INDIRECTTI       ((uint16_t)0x0002)                      /*!< channel y is configured as input and icy is mapped on opposite input */
#define TIMER_IC_SELECTION_TRC              ((uint16_t)0x0003)                      /*!< channel y is configured as input and icy is mapped on TRC */

/* channel input capture prescaler */
#define TIMER_IC_PSC_DIV1                   ((uint16_t)0x0000)                      /*!< no prescaler */
#define TIMER_IC_PSC_DIV2                   ((uint16_t)0x0004)                      /*!< divided by 2 */
#define TIMER_IC_PSC_DIV4                   ((uint16_t)0x0008)                      /*!< divided by 4*/
#define TIMER_IC_PSC_DIV8                   ((uint16_t)0x000C)                      /*!< divided by 8 */

/* channel output compare shadow enable */
#define TIMER_OC_SHADOW_ENABLE              ((uint16_t)0x0008)                      /*!< channel output shadow state enable */
#define TIMER_OC_SHADOW_DISABLE             ((uint16_t)0x0000)                      /*!< channel output shadow state disable */
...
#define TIMER_OC_CLEAR_ENABLE               ((uint16_t)0x0080)                      /*!< channel output clear function enable */
#define TIMER_OC_CLEAR_DISABLE              ((uint16_t)0x0000)                      /*!< channel output clear function disable */

/* channel output compare mode */
#define TIMER_OC_MODE_TIMING                ((uint16_t)0x0000)                      /*!< timing mode */
#define TIMER_OC_MODE_ACTIVE                ((uint16_t)0x0010)                      /*!< active mode */
#define TIMER_OC_MODE_INACTIVE              ((uint16_t)0x0020)                      /*!< inactive mode */
#define TIMER_OC_MODE_TOGGLE                ((uint16_t)0x0030)                      /*!< toggle mode */
#define TIMER_OC_MODE_LOW                   ((uint16_t)0x0040)                      /*!< force low mode */
#define TIMER_OC_MODE_HIGH                  ((uint16_t)0x0050)                      /*!< force high mode */
#define TIMER_OC_MODE_PWM0                  ((uint16_t)0x0060)                      /*!< PWM0 mode */
#define TIMER_OC_MODE_PWM1                  ((uint16_t)0x0070)                      /*!< PWM1 mode*/

/* channel input capture polarity */
#define TIMER_IC_POLARITY_RISING            ((uint16_t)0x0000)                      /*!< input capture rising edge */
#define TIMER_IC_POLARITY_FALLING           ((uint16_t)0x0002)                      /*!< input capture falling edge */
#define TIMER_IC_POLARITY_BOTH_EDGE         ((uint16_t)0x000A)                      /*!< input capture both edge */

/* channel enable state*/
#define TIMER_CCX_ENABLE                    ((uint16_t)0x0001)                      /*!< channel enable  */
#define TIMER_CCX_DISABLE                   ((uint16_t)0x0000)                      /*!< channel disable  */

/* channel complementary output enable state*/
#define TIMER_CCXN_ENABLE                   ((uint16_t)0x0004)                      /*!< channel complementary enable */
#define TIMER_CCXN_DISABLE                  ((uint16_t)0x0000)                      /*!< channel complementary disable */

/* channel output polarity */
#define TIMER_OC_POLARITY_HIGH              ((uint16_t)0x0000)                      /*!< channel output polarity is high */
#define TIMER_OC_POLARITY_LOW               ((uint16_t)0x0002)                      /*!< channel output polarity is low */

/* channel complementary output polarity */
#define TIMER_OCN_POLARITY_HIGH             ((uint16_t)0x0000)                      /*!< channel complementary output polarity is high */
#define TIMER_OCN_POLARITY_LOW              ((uint16_t)0x0008)                      /*!< channel complementary output polarity is low */

/* output automatic enable */
#define TIMER_OUTAUTO_ENABLE                ((uint16_t)0x4000)                      /*!< output automatic enable */
#define TIMER_OUTAUTO_DISABLE               ((uint16_t)0x0000)                      /*!< output automatic disable */

/* break input polarity */
#define TIMER_BREAK_POLARITY_LOW            ((uint16_t)0x0000)                      /*!< break input polarity is low */
#define TIMER_BREAK_POLARITY_HIGH           ((uint16_t)0x2000)                      /*!< break input polarity is high */

/* break input enable */
#define TIMER_BREAK_ENABLE                  ((uint16_t)0x1000)                      /*!< break input enable */
#define TIMER_BREAK_DISABLE                 ((uint16_t)0x0000)                      /*!< break input disable */

/* run mode off-state configure */
#define TIMER_ROS_STATE_ENABLE              ((uint16_t)0x0800)                      /*!< channel OC outputs enable in run mode */
#define TIMER_ROS_STATE_DISABLE             ((uint16_t)0x0000)                      /*!< channel OC outputs disable in run mode */

/* idle mode off-state configure */                                                 
#define TIMER_IOS_STATE_ENABLE              ((uint16_t)0x0400)                      /*!< channel OC outputs enable in idle mode */
#define TIMER_IOS_STATE_DISABLE             ((uint16_t)0x0000)                      /*!< channel OC outputs disable in idle mode */

/* complementary register protect control */
#define CCHP_PROT(regval)                   (BITS(8, 9) & ((regval) << 8))
...
#define DMACFG_DMATA(regval)                (BITS(0, 4) & ((regval) << 0))
...
#define DMACFG_DMATC(regval)                (BITS(8, 12) & ((regval) << 8))
...
#define IRMP_CI0_RMP(regval)                (BITS(0, 1) & ((regval) << 0))
...
/* write cc register selection */
#define TIMER_CCSEL_DISABLE                 ((uint16_t)0x0000)                      /*!< write CC register selection disable */
#define TIMER_CCSEL_ENABLE                  ((uint16_t)0x0002)                      /*!< write CC register selection enable */

/* the output value selection */
#define TIMER_OUTSEL_DISABLE                ((uint16_t)0x0000)                      /*!< output value selection disable */
#define TIMER_OUTSEL_ENABLE                 ((uint16_t)0x0001)                      /*!< output value selection enable */
...
void timer_quadrature_decoder_mode_config(uint32_t timer_periph,uint32_t timer_decomode,uint32_t timer_ic0olarity,uint32_t timer_ic1olarity);
...
void timer_extrx_external_clock_config(uint32_t timer_periph,uint32_t timer_extrigger, uint32_t timer_expolarity,uint32_t timer_extfilter);
