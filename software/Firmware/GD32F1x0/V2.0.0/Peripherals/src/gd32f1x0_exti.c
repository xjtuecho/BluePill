...
#define EXTI_LINE_NULL     ((uint32_t)0x00000000)  /*!< No interrupt line is selected */

#define EXTI_IER_RST       ((uint32_t)0x0F900000)  /*!< The reset value of EXTI_IER */

#define EXTI_EER_RST       ((uint32_t)0x00000000)  /*!< The reset value of EXTI_EER */

#define EXTI_RTE_RST       ((uint32_t)0x00000000)  /*!< The reset value of EXTI_RTE */

#define EXTI_FTE_RST       ((uint32_t)0x00000000)  /*!< The reset value of EXTI_FTE */

#define EXTI_PD_RST        ((uint32_t)0x006FFFFF)  /*!< The reset value of EXTI_PD */
