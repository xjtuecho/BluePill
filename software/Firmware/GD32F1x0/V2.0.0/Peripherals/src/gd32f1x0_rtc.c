...
/** @defgroup RTC_Private_Defines
  * @{
  */
#define INITF_TIMEOUT                  ((uint32_t) 0x00004000)       /*!< Initialization state flag timeout */
#define RSF_TIMEOUT                    ((uint32_t) 0x00008000)       /*!< Register synchronization flag timeout */
#define RECALPF_TIMEOUT                ((uint32_t) 0x00001000)       /*!< Recalibration pending flag timeout */
#define SHPF_TIMEOUT                   ((uint32_t) 0x00001000)       /*!< Shift function operation pending flag timeout */
#define AWF_TIMEOUT                    ((uint32_t) 0x00008000)       /*!< Alarm configuration can be write flag timeout */

#define RTC_KEY1                       ((uint8_t) 0xCA)              /*!< RTC unlock key1 */
#define RTC_KEY2                       ((uint8_t) 0x53)              /*!< RTC unlock key2 */
#define RTC_LOCK                       ((uint8_t) 0xFF)              /*!< RTC lock key */

#define RTC_HOUR_POS                   16                            /*!< RTC hour bit shift */
#define RTC_MINUTE_POS                 8                             /*!< RTC minute bit shift */
#define RTC_MONTH_POS                  8                             /*!< RTC month bit shift */
#define RTC_DATE_POS                   24                            /*!< RTC date bit shift */
#define RTC_WEEKDAY_POS                13                            /*!< RTC weekday bit shift */
#define RTC_YEAR_POS                   16                            /*!< RTC year bit shift */
#define RTC_PRESC_ASYN_POS             16                            /*!< RTC synchronous prescaler bit shift */
#define RTC_TMPER_TRI_POS              1                             /*!< RTC Tamper trigger bit shift */
