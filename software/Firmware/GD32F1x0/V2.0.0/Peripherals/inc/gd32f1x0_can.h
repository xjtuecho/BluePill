...
#ifndef __GD32F1X0_CAN_H
#define __GD32F1X0_CAN_H
...
/** 
  * @brief  CAN Tx message Parameters definition  
  */
...
/** 
  * @brief  CAN Rx message Parameters definition  
  */
