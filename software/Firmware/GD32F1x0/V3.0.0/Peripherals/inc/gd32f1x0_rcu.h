...
#define RCU_CTL0                    REG32(RCU + 0x00)         /*!< control register 0 */
#define RCU_CFG0                    REG32(RCU + 0x04)         /*!< configuration register 0 */
#define RCU_INT                     REG32(RCU + 0x08)         /*!< interrupt register */
#define RCU_APB2RST                 REG32(RCU + 0x0C)         /*!< APB2 reset register */
#define RCU_APB1RST                 REG32(RCU + 0x10)         /*!< APB1 reset register */
#define RCU_AHBEN                   REG32(RCU + 0x14)         /*!< AHB enable register */
#define RCU_APB2EN                  REG32(RCU + 0x18)         /*!< APB2 enable register */
#define RCU_APB1EN                  REG32(RCU + 0x1C)         /*!< APB1 enable register  */
#define RCU_BDCTL                   REG32(RCU + 0x20)         /*!< backup domain control register */
#define RCU_RSTSCK                  REG32(RCU + 0x24)         /*!< reset source /clock register */
#define RCU_AHBRST                  REG32(RCU + 0x28)         /*!< AHB reset register */
#define RCU_CFG1                    REG32(RCU + 0x2C)         /*!< configuration register 1 */
#define RCU_CFG2                    REG32(RCU + 0x30)         /*!< configuration register 2 */
#define RCU_CTL1                    REG32(RCU + 0x34)         /*!< control register 1 */
#ifdef GD32F170_190
#define RCU_CFG3                    REG32(RCU + 0x80)         /*!< configuration register 3 */
#endif /* GD32F170_190 */
#define RCU_ADDEN                   REG32(RCU + 0xF8)         /*!< additional enable register */
#define RCU_ADDRST                  REG32(RCU + 0xFC)         /*!< additional reset register */
#define RCU_VKEY                    REG32(RCU + 0x100)        /*!< voltage key register */
#define RCU_DSV                     REG32(RCU + 0x134)        /*!< deep-sleep mode voltage register */
#ifdef GD32F130_150
#define RCU_PDVSEL                  REG32(RCU + 0x138)        /*!< power down voltage select register */
#endif /* GD32F130_150 */
...
/* RCU_AHBEN */
#define RCU_AHBEN_DMAEN             BIT(0)                    /*!< DMA0 clock enable */
...
/* RCU_ADDEN */
#define RCU_ADDEN_I2C2EN            BIT(0)                    /*!< I2C2 unit clock enable */

/* RCU_ADDRST */
#define RCU_ADDRST_I2C2RST          BIT(0)                    /*!< I2C2 unit reset */
...
#define REGIDX_BIT(regidx, bitpos)      (((regidx)<<6) | (bitpos))
#define REG_VAL(periph)                 (REG32(RCU + ((periph)>>6)))
#define BIT_POS(val)                    ((val) & 0x1F)
...
{
    /* AHB peripherals */
    RCU_DMA     = REGIDX_BIT(IDX_AHBEN, 0),                  /*!< DMA clock */
    RCU_SRAM    = REGIDX_BIT(IDX_AHBEN, 2),                  /*!< SRAM clock */
    RCU_FMC     = REGIDX_BIT(IDX_AHBEN, 4),                  /*!< FMC clock */
    RCU_CRC     = REGIDX_BIT(IDX_AHBEN, 6),                  /*!< CRC clock */
    RCU_GPIOA   = REGIDX_BIT(IDX_AHBEN, 17),                 /*!< GPIOA clock */
    RCU_GPIOB   = REGIDX_BIT(IDX_AHBEN, 18),                 /*!< GPIOB clock */
    RCU_GPIOC   = REGIDX_BIT(IDX_AHBEN, 19),                 /*!< GPIOC clock */
    RCU_GPIOD   = REGIDX_BIT(IDX_AHBEN, 20),                 /*!< GPIOD clock */
    RCU_GPIOF   = REGIDX_BIT(IDX_AHBEN, 22),                 /*!< GPIOF clock */
    RCU_TSI     = REGIDX_BIT(IDX_AHBEN, 24),                 /*!< TSI clock */
    
    /* APB2 peripherals */
    RCU_CFGCMP  = REGIDX_BIT(IDX_APB2EN, 0),                 /*!< CFGCMP clock */
    RCU_ADC     = REGIDX_BIT(IDX_APB2EN, 9),                 /*!< ADC clock */
    RCU_TIMER0  = REGIDX_BIT(IDX_APB2EN, 11),                /*!< TIMER0 clock */
    RCU_SPI0    = REGIDX_BIT(IDX_APB2EN, 12),                /*!< SPI0 clock */
    RCU_USART0  = REGIDX_BIT(IDX_APB2EN, 14),                /*!< USART0 clock */
    RCU_TIMER14 = REGIDX_BIT(IDX_APB2EN, 16),                /*!< TIMER14 clock */
    RCU_TIMER15 = REGIDX_BIT(IDX_APB2EN, 17),                /*!< TIMER15 clock */
    RCU_TIMER16 = REGIDX_BIT(IDX_APB2EN, 18),                /*!< TIMER16 clock */
    
    /* APB1 peripherals */
    RCU_TIMER1  = REGIDX_BIT(IDX_APB1EN, 0),                 /*!< TIMER1 clock */
    RCU_TIMER2  = REGIDX_BIT(IDX_APB1EN, 1),                 /*!< TIMER2 clock */
    RCU_TIMER5  = REGIDX_BIT(IDX_APB1EN, 4),                 /*!< TIMER5 clock */
    RCU_TIMER13 = REGIDX_BIT(IDX_APB1EN, 8),                 /*!< TIMER13 clock */
#ifdef GD32F170_190
    RCU_SLCD    = REGIDX_BIT(IDX_APB1EN, 9),                /*!< SLCD clock */
#endif /* GD32F170_190 */
    RCU_WWDGT   = REGIDX_BIT(IDX_APB1EN, 11),                /*!< WWDGT clock */
    RCU_SPI1    = REGIDX_BIT(IDX_APB1EN, 14),                /*!< SPI1 clock */
    RCU_SPI2    = REGIDX_BIT(IDX_APB1EN, 15),                /*!< SPI2 clock */
    RCU_USART1  = REGIDX_BIT(IDX_APB1EN, 17),                /*!< USART1 clock */
    RCU_I2C0    = REGIDX_BIT(IDX_APB1EN, 21),                /*!< I2C0 clock */
    RCU_I2C1    = REGIDX_BIT(IDX_APB1EN, 22),                /*!< I2C1 clock */
#ifdef GD32F130_150
    RCU_USBD    = REGIDX_BIT(IDX_APB1EN, 23),                /*!< USBD clock */
#endif /* GD32F130_150 */
#ifdef GD32F170_190
    RCU_CAN0    = REGIDX_BIT(IDX_APB1EN, 25),                /*!< CAN0 clock */
    RCU_CAN1    = REGIDX_BIT(IDX_APB1EN, 26),                /*!< CAN1 clock */
#endif /* GD32F170_190 */
    RCU_PMU     = REGIDX_BIT(IDX_APB1EN, 28),                /*!< PMU clock */
    RCU_DAC     = REGIDX_BIT(IDX_APB1EN, 29),                /*!< DAC clock */
    RCU_CEC     = REGIDX_BIT(IDX_APB1EN, 30),                /*!< CEC clock */
#ifdef GD32F170_190
    RCU_OPAIVREF = REGIDX_BIT(IDX_APB1EN, 31),               /*!< OPAIVREF clock */
#endif /* GD32F170_190 */
    RCU_RTC     = REGIDX_BIT(IDX_BDCTL, 15),                 /*!< RTC clock */
    
    /* RCU_ADDEN */
    RCU_I2C2    = REGIDX_BIT(IDX_ADDEN, 0)                   /*!< I2C2 clock */
}rcu_periph_enum;
...
typedef enum
{
    ...
    RCU_GPIOARST   = REGIDX_BIT(IDX_AHBRST, 17),             /*!< GPIOA reset */
    RCU_GPIOBRST   = REGIDX_BIT(IDX_AHBRST, 18),             /*!< GPIOB reset */
    RCU_GPIOCRST   = REGIDX_BIT(IDX_AHBRST, 19),             /*!< GPIOC reset */
    RCU_GPIODRST   = REGIDX_BIT(IDX_AHBRST, 20),             /*!< GPIOD reset */
    RCU_GPIOFRST   = REGIDX_BIT(IDX_AHBRST, 22),             /*!< GPIOF reset */
    RCU_TSIRST     = REGIDX_BIT(IDX_AHBRST, 24),             /*!< TSI reset */
    
    /* APB2 peripherals reset */
    RCU_CFGRST     = REGIDX_BIT(IDX_APB2RST, 0),             /*!< CFG reset */
    RCU_ADCRST     = REGIDX_BIT(IDX_APB2RST, 9),             /*!< ADC reset */
    RCU_TIMER0RST  = REGIDX_BIT(IDX_APB2RST, 11),            /*!< TIMER0 reset */
    RCU_SPI0RST    = REGIDX_BIT(IDX_APB2RST, 12),            /*!< SPI0 reset */
    RCU_USART0RST  = REGIDX_BIT(IDX_APB2RST, 14),            /*!< USART0 reset */
    RCU_TIMER14RST = REGIDX_BIT(IDX_APB2RST, 16),            /*!< TIMER14 reset */
    RCU_TIMER15RST = REGIDX_BIT(IDX_APB2RST, 17),            /*!< TIMER15 reset */
    RCU_TIMER16RST = REGIDX_BIT(IDX_APB2RST, 18),            /*!< TIMER16 reset */
    
    /* APB1 peripherals reset */
    RCU_TIMER1RST  = REGIDX_BIT(IDX_APB1RST, 0),             /*!< TIMER1 reset */
    RCU_TIMER2RST  = REGIDX_BIT(IDX_APB1RST, 1),             /*!< TIMER2 reset */
    RCU_TIMER5RST  = REGIDX_BIT(IDX_APB1RST, 4),             /*!< TIMER5 reset */
    RCU_TIMER13RST = REGIDX_BIT(IDX_APB1RST, 8),             /*!< TIMER13 reset */
#ifdef GD32F170_190
    RCU_SLCDRST    = REGIDX_BIT(IDX_APB1RST, 9),             /*!< SLCD reset */
#endif /* GD32F170_190 */
    RCU_WWDGTRST   = REGIDX_BIT(IDX_APB1RST, 11),            /*!< WWDGT reset */
    RCU_SPI1RST    = REGIDX_BIT(IDX_APB1RST, 14),            /*!< SPI1 reset */
    RCU_SPI2RST    = REGIDX_BIT(IDX_APB1RST, 15),            /*!< SPI2 reset */
    RCU_USART1RST  = REGIDX_BIT(IDX_APB1RST, 17),            /*!< USART1 reset */
    RCU_I2C0RST    = REGIDX_BIT(IDX_APB1RST, 21),            /*!< I2C0 reset */
    RCU_I2C1RST    = REGIDX_BIT(IDX_APB1RST, 22),            /*!< I2C1 reset */
#ifdef GD32F130_150
    RCU_USBDRST    = REGIDX_BIT(IDX_APB1RST, 23),            /*!< USBD reset */
#endif /* GD32F130_150 */
#ifdef GD32F170_190
    RCU_CAN0RST    = REGIDX_BIT(IDX_APB1RST, 25),            /*!< CAN0 reset */
    RCU_CAN1RST    = REGIDX_BIT(IDX_APB1RST, 26),            /*!< CAN1 reset */
#endif /* GD32F170_190 */
    RCU_PMURST     = REGIDX_BIT(IDX_APB1RST, 28),            /*!< PMU reset */
    RCU_DACRST     = REGIDX_BIT(IDX_APB1RST, 29),            /*!< DAC reset */
    RCU_CECRST     = REGIDX_BIT(IDX_APB1RST, 30),            /*!< CEC reset */
#ifdef GD32F170_190
    RCU_OPAIVREFRST = REGIDX_BIT(IDX_APB1RST, 31),           /*!< OPAIVREF reset */
#endif /* GD32F170_190 */

    /* RCU_ADDRST */
    RCU_I2C2RST    = REGIDX_BIT(IDX_ADDRST, 0),              /*!< I2C2 reset */
}rcu_periph_reset_enum;

/* clock stabilization and peripheral reset flags */
typedef enum
{
    RCU_FLAG_IRC40KSTB    = REGIDX_BIT(IDX_STB, 1),          /*!< IRC40K stabilization flags */
    RCU_FLAG_LXTALSTB     = REGIDX_BIT(IDX_BDCTL, 1),        /*!< LXTAL stabilization flags */
    RCU_FLAG_IRC8MSTB     = REGIDX_BIT(IDX_CTL0, 1),         /*!< IRC8M stabilization flags */
    RCU_FLAG_HXTALSTB     = REGIDX_BIT(IDX_CTL0, 17),        /*!< HXTAL stabilization flags */
    RCU_FLAG_PLLSTB       = REGIDX_BIT(IDX_CTL0, 25),        /*!< PLL stabilization flags */
#ifdef GD32F130_150
    RCU_FLAG_IRC14MSTB    = REGIDX_BIT(IDX_CTL1, 1),         /*!< IRC14M stabilization flags */
#elif defined (GD32F170_190)
    RCU_FLAG_IRC28MSTB    = REGIDX_BIT(IDX_CTL1, 1),         /*!< IRC28M stabilization flags */
#endif /* GD32F130_150 */
    RCU_FLAG_V12RST       = REGIDX_BIT(IDX_RSTSCK, 23),      /*!< V12 reset flags */
    RCU_FLAG_OBLRST       = REGIDX_BIT(IDX_RSTSCK, 25),      /*!< OBL reset flags */
    RCU_FLAG_EPRST        = REGIDX_BIT(IDX_RSTSCK, 26),      /*!< EPR reset flags */
    RCU_FLAG_PMURST       = REGIDX_BIT(IDX_RSTSCK, 27),      /*!< PMU reset flags */
    RCU_FLAG_SWRST        = REGIDX_BIT(IDX_RSTSCK, 28),      /*!< SW  reset flags */
    RCU_FLAG_FWDGTRST     = REGIDX_BIT(IDX_RSTSCK, 29),      /*!< FWDGT reset flags */
    RCU_FLAG_WWDGTRST     = REGIDX_BIT(IDX_RSTSCK, 30),      /*!< WWDGT reset flags */
    RCU_FLAG_LPRST        = REGIDX_BIT(IDX_RSTSCK, 31)       /*!< LP reset flags */
}rcu_flag_enum;
...
typedef enum
{
    RCU_HXTAL   = REGIDX_BIT(IDX_CTL0, 16),                  /*!< HXTAL */
    RCU_LXTAL   = REGIDX_BIT(IDX_BDCTL, 0),                  /*!< LXTAL */
    RCU_IRC8M   = REGIDX_BIT(IDX_CTL0, 0),                   /*!< IRC8M */
#ifdef GD32F130_150
    RCU_IRC14M  = REGIDX_BIT(IDX_CTL1, 0),                   /*!< IRC14M */
#elif defined (GD32F170_190)
    RCU_IRC28M  = REGIDX_BIT(IDX_CTL1, 0),                   /*!< IRC28M */
#endif /* GD32F130_150 */
    RCU_IRC40K  = REGIDX_BIT(IDX_RSTSCK, 0),                 /*!< IRC40K */
    RCU_PLL     = REGIDX_BIT(IDX_CTL0, 24)                   /*!< PLL */
}rcu_osci_type_enum;
...
#define CFG0_SCS(regval)            (BITS(0,1) & ((regval) << 0))
...
#define CFG0_SCSS(regval)           (BITS(2,3) & ((regval) << 2))
...
#define CFG0_APB1PSC(regval)        (BITS(8,10) & ((regval) << 8))
...
#define CFG0_APB2PSC(regval)        (BITS(11,13) & ((regval) << 11))
...
#define CFG0_ADCPSC(regval)         (BITS(14,15) & ((regval) << 14))
...
/* PLL multiply factor */
#define CFG0_PLLMF(regval)          (BITS(18,21) & ((regval) << 18))
...
#define CFG0_USBDPSC(regval)        (BITS(22,23) & ((regval) << 22))
...
#define CFG0_CKOUTSEL(regval)       (BITS(24,26) & ((regval) << 24))
#define RCU_CKOUTSEL_NONE           CFG0_CKOUTSEL(0)                     /*!< no clock selected */
#define RCU_CKOUTSEL_IRC14M         CFG0_CKOUTSEL(1)                     /*!< CK_OUT clock source select IRC14M */
#define RCU_CKOUTSEL_IRC40K         CFG0_CKOUTSEL(2)                     /*!< CK_OUT clock source select IRC40K */
#define RCU_CKOUTSEL_LXTAL          CFG0_CKOUTSEL(3)                     /*!< CK_OUT clock source select LXTAL */
#define RCU_CKOUTSEL_CKSYS          CFG0_CKOUTSEL(4)                     /*!< CK_OUT clock source select CKSYS */
#define RCU_CKOUTSEL_IRC8M          CFG0_CKOUTSEL(5)                     /*!< CK_OUT clock source select IRC8M */
#define RCU_CKOUTSEL_HXTAL          CFG0_CKOUTSEL(6)                     /*!< CK_OUT clock source select HXTAL */
#define RCU_CKOUTSEL_CKPLL_DIV1     (RCU_CFG0_PLLDV | CFG0_CKOUTSEL(7))  /*!< CK_OUT clock source select CK_PLL */
#define RCU_CKOUTSEL_CKPLL_DIV2     CFG0_CKOUTSEL(7)                     /*!< CK_OUT clock source select CK_PLL/2 */

/* CK_OUT divider */
#define CFG0_CKOUTDIV(regval)       (BITS(28,30) & ((regval) << 28))
...
#define CFG0_CKOUT0SEL(regval)      (BITS(24,26) & ((regval) << 24))
#define RCU_CKOUT0SEL_NONE          CFG0_CKOUT0SEL(0)                    /*!< no clock selected */
#define RCU_CKOUT0SEL_IRC28M        CFG0_CKOUT0SEL(1)                    /*!< CK_OUT0 clock source select IRC28M */
#define RCU_CKOUT0SEL_IRC40K        CFG0_CKOUT0SEL(2)                    /*!< CK_OUT0 clock source select IRC40K */
#define RCU_CKOUT0SEL_LXTAL         CFG0_CKOUT0SEL(3)                    /*!< CK_OUT0 clock source select LXTAL */
#define RCU_CKOUT0SEL_CKSYS         CFG0_CKOUT0SEL(4)                    /*!< CK_OUT0 clock source select CKSYS */
#define RCU_CKOUT0SEL_IRC8M         CFG0_CKOUT0SEL(5)                    /*!< CK_OUT0 clock source select IRC8M */
#define RCU_CKOUT0SEL_HXTAL         CFG0_CKOUT0SEL(6)                    /*!< CK_OUT0 clock source select HXTAL */
#define RCU_CKOUT0SEL_CKPLL_DIV1    (RCU_CFG0_PLLDV | CFG0_CKOUT0SEL(7)) /*!< CK_OUT0 clock source select CK_PLL */
#define RCU_CKOUT0SEL_CKPLL_DIV2    CFG0_CKOUT0SEL(7)                    /*!< CK_OUT0 clock source select CK_PLL/2 */

/* CK_OUT0 divider */
#define CFG0_CKOUT0DIV(regval)      (BITS(28,30) & ((regval) << 28))
...
#define RCU_PLLDV_CKPLL_DIV2        (uint32_t)0x00000000                /*!< CK_PLL divide by 2 for CK_OUT */
#define RCU_PLLDV_CKPLL             RCU_CFG0_PLLDV                      /*!< CK_PLL divide by 1 for CK_OUT */

/* LXTAL drive capability */
#define BDCTL_LXTALDRI(regval)      (BITS(3,4) & ((regval) << 3))
...
#define BDCTL_RTCSRC(regval)        (BITS(8,9) & ((regval) << 8))
#define RCU_RTC_NONE                BDCTL_RTCSRC(0)                     /*!< no clock selected */
#define RCU_RTC_LXTAL               BDCTL_RTCSRC(1)                     /*!< LXTAL selected as RTC source clock */
#define RCU_RTC_IRC40K              BDCTL_RTCSRC(2)                     /*!< IRC40K selected as RTC source clock */
#define RCU_RTC_HXTAL_DIV32         BDCTL_RTCSRC(3)                     /*!< HXTAL/32 selected as RTC source clock */

#ifdef GD32F170_190
/* SLCD clock entry selection */
#define BDCTL_RTCSRC(regval)        (BITS(8,9) & ((regval) << 8))
#define RCU_SLCD_NONE               BDCTL_RTCSRC(0)                     /*!< no clock selected */
#define RCU_SLCD_LXTAL              BDCTL_RTCSRC(1)                     /*!< LXTAL selected as SLCD source clock */
#define RCU_SLCD_IRC40K             BDCTL_RTCSRC(2)                     /*!< IRC40K selected as SLCD source clock */
#define RCU_SLCD_HXTAL_DIV32        BDCTL_RTCSRC(3)                     /*!< HXTAL/32 selected as SLCD source clock */
#endif /* GD32F170_190 */

/* CK_HXTAL divider previous PLL */
#define CFG1_HXTALPREDV(regval)     (BITS(0,3) & ((regval) << 0))
...
#define CFG2_USART0SEL(regval)      (BITS(0,1) & ((regval) << 0))
...
#define RCU_CECSRC_IRC8M_DIV244     (uint32_t)0x00000000                /*!< CK_CEC clock source select IRC8M/244 */
#define RCU_CECSRC_LXTAL            RCU_CFG2_CECSEL                     /*!< CK_CEC clock source select LXTAL */

#ifdef GD32F130_150
/* ADC clock source selection */
#define RCU_ADCSRC_IRC14M           (uint32_t)0x00000000                /*!< ADC clock source select */
#define RCU_ADCSRC_APB2DIV          RCU_CFG2_ADCSEL                     /*!< ADC clock source select */
#elif defined (GD32F170_190)
/* ADC clock source selection */
#define RCU_ADCSRC_IRC28M           (uint32_t)0x00000000                /*!< ADC clock source select */
#define RCU_ADCSRC_APB2DIV          RCU_CFG2_ADCSEL                     /*!< ADC clock source select */

/* IRC28M clock divider for ADC */
#define RCU_ADC_IRC28M_DIV2         (uint32_t)0x00000000                /*!< IRC28M/2 select to ADC clock */
#define RCU_ADC_IRC28M_DIV1         RCU_CFG2_IRC28MDIV                  /*!< IRC28M select to ADC clock */

/* CK_OUT1 Clock Source Selection */
#define CFG3_CKOUT1SRC(regval)      (BITS(0,2) & ((regval) << 0))
...
#define RCU_CKOUT1SRC_CKPLL_DIV1    0x00000007                          /*!< CK_OUT1 clock source select CK_PLL */
#define RCU_CKOUT1SRC_CKPLL_DIV2    0x00000008                          /*!< CK_OUT1 clock source select CK_PLL/2 */

/* CK_OUT1 divider */
#define CFG3_CKOUT1DIV(regval)      (BITS(8,13) & ((regval) << 8))
...
#define DSV_DSLPVS(regval)          (BITS(0,2) & ((regval) << 0))
...
#define RCU_PDR_V_2_6               (uint32_t)0x00000000                /*!< power down voltage is 2.6V */
...
/* wait until HXTAL stabilization flag is SET, or HXTAL startup is timeout */
