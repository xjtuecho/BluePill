...
#define EXTI_INTEN                  REG32(EXTI + 0x00)       /*!< interrupt enable register */
#define EXTI_EVEN                   REG32(EXTI + 0x04)       /*!< event enable register */
#define EXTI_RTEN                   REG32(EXTI + 0x08)       /*!< rising edge trigger enable register */
#define EXTI_FTEN                   REG32(EXTI + 0x0C)       /*!< falling trigger enable register */
#define EXTI_SWIEV                  REG32(EXTI + 0x10)       /*!< software interrupt event register */
#define EXTI_PD                     REG32(EXTI + 0x14)       /*!< pending register */
