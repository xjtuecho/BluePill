...
#define WWDGT_CTL                   REG32((WWDGT) + 0x00)           /*!< WWDGT control register */
#define WWDGT_CFG                   REG32((WWDGT) + 0x04)           /*!< WWDGT configuration register */
#define WWDGT_STAT                  REG32((WWDGT) + 0x08)           /*!< WWDGT status register */
...
/* ctl register value */
#define CTL_CNT(regval)             (BITS(0,6) & ((regval) << 0))   /*!< write value to WWDGT_CTL_CNT bit field */

/* cfg register value */
#define CFG_WIN(regval)             (BITS(0,6) & ((regval) << 0))   /*!< write value to WWDGT_CFG_WIN bit field */

#define CFG_PSC(regval)             (BITS(7,8) & ((regval) << 7))   /*!< write value to WWDGT_CFG_PSC bit field */
