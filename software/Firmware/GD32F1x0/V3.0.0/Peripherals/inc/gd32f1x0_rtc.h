...
#define RTC_TIME                           REG32((RTC) + 0x00)                  /*!< RTC time of day register */
#define RTC_DATE                           REG32((RTC) + 0x04)                  /*!< RTC date register */
#define RTC_CTL                            REG32((RTC) + 0x08)                  /*!< RTC control register */
#define RTC_STAT                           REG32((RTC) + 0x0C)                  /*!< RTC status register */
#define RTC_PSC                            REG32((RTC) + 0x10)                  /*!< RTC time prescaler register */
#define RTC_ALRM0TD                        REG32((RTC) + 0x1C)                  /*!< RTC alarm 0 time and date register */
#define RTC_WPK                            REG32((RTC) + 0x24)                  /*!< RTC write protection key register */
#define RTC_SS                             REG32((RTC) + 0x28)                  /*!< RTC sub second register */
#define RTC_SHIFTCTL                       REG32((RTC) + 0x2C)                  /*!< RTC shift function control register */
#define RTC_TTS                            REG32((RTC) + 0x30)                  /*!< RTC time of timestamp register */
#define RTC_DTS                            REG32((RTC) + 0x34)                  /*!< RTC date of timestamp register */
#define RTC_SSTS                           REG32((RTC) + 0x38)                  /*!< RTC sub second of timestamp register */
#define RTC_HRFC                           REG32((RTC) + 0x3C)                  /*!< RTC high resolution frequency compensation registor */
#define RTC_TAMP                           REG32((RTC) + 0x40)                  /*!< RTC tamper register */
#define RTC_ALRM0SS                        REG32((RTC) + 0x44)                  /*!< RTC alarm 0 sub second register */
#define RTC_BKP0                           REG32((RTC) + 0x50)                  /*!< RTC backup register */
#define RTC_BKP1                           REG32((RTC) + 0x54)                  /*!< RTC backup register */
#define RTC_BKP2                           REG32((RTC) + 0x58)                  /*!< RTC backup register */
#define RTC_BKP3                           REG32((RTC) + 0x5C)                  /*!< RTC backup register */
#define RTC_BKP4                           REG32((RTC) + 0x60)                  /*!< RTC backup register */
...
/* time register value */
#define TIME_SC(regval)                    (BITS(0,6) & ((regval) << 0))        /*!< write value to RTC_TIME_SC bit field */
#define GET_TIME_SC(regval)                GET_BITS((regval),0,6)               /*!< get value of RTC_TIME_SC bit field */

#define TIME_MN(regval)                    (BITS(8,14) & ((regval) << 8))       /*!< write value to RTC_TIME_MN bit field */
#define GET_TIME_MN(regval)                GET_BITS((regval),8,14)              /*!< get value of RTC_TIME_MN bit field */

#define TIME_HR(regval)                    (BITS(16,21) & ((regval) << 16))     /*!< write value to RTC_TIME_HR bit field */
...
/* date register value */
#define DATE_DAY(regval)                   (BITS(0,5) & ((regval) << 0))        /*!< write value to RTC_DATE_DAY bit field */
#define GET_DATE_DAY(regval)               GET_BITS((regval),0,5)               /*!< get value of RTC_DATE_DAY bit field */

#define DATE_MON(regval)                   (BITS(8,12) & ((regval) << 8))       /*!< write value to RTC_DATE_MON bit field */
...
#define DATE_DOW(regval)                   (BITS(13,15) & ((regval) << 13))     /*!< write value to RTC_DATE_DOW bit field */
...
#define DATE_YR(regval)                    (BITS(16,23) & ((regval) << 16))     /*!< write value to RTC_DATE_YR bit field */
#define GET_DATE_YR(regval)                GET_BITS((regval),16,23)             /*!< get value of RTC_DATE_YR bit field */

/* ctl register value */
#define CTL_OS(regval)                     (BITS(21,22) & ((regval) << 21))     /*!< write value to RTC_CTL_OS bit field */
...
/* psc register value */
#define PSC_FACTOR_S(regval)               (BITS(0,14) & ((regval) << 0))       /*!< write value to RTC_PSC_FACTOR_S bit field */
#define GET_PSC_FACTOR_S(regval)           GET_BITS((regval),0,14)              /*!< get value of RTC_PSC_FACTOR_S bit field */

#define PSC_FACTOR_A(regval)               (BITS(16,22) & ((regval) << 16))     /*!< write value to RTC_PSC_FACTOR_A bit field */
#define GET_PSC_FACTOR_A(regval)           GET_BITS((regval),16,22)             /*!< get value of RTC_PSC_FACTOR_A bit field */

/* alrm0td register value */
#define ALRM0TD_SC(regval)                 (BITS(0,6) & ((regval)<< 0))         /*!< write value to RTC_ALRM0TD_SC bit field */
#define GET_ALRM0TD_SC(regval)             GET_BITS((regval),0,6)               /*!< get value of RTC_ALRM0TD_SC bit field */

#define ALRM0TD_MN(regval)                 (BITS(8,14) & ((regval) << 8))       /*!< write value to RTC_ALRM0TD_MN bit field */
#define GET_ALRM0TD_MN(regval)             GET_BITS((regval),8,14)              /*!< get value of RTC_ALRM0TD_MN bit field */

#define ALRM0TD_HR(regval)                 (BITS(16,21) & ((regval) << 16))     /*!< write value to RTC_ALRM0TD_HR bit field */
#define GET_ALRM0TD_HR(regval)             GET_BITS((regval),16,21)             /*!< get value of RTC_ALRM0TD_HR bit field */

#define ALRM0TD_DAY(regval)                (BITS(24,29) & ((regval) << 24))     /*!< write value to RTC_ALRM0TD_DAY bit field */
...
/* wpk register value */
#define WPK_WPK(regval)                    (BITS(0,7) & ((regval) << 0))        /*!< write value to RTC_WPK_WPK bit field */

/* ss register value */
#define SS_SSC(regval)                     (BITS(0,15) & ((regval) << 0))       /*!< write value to RTC_SS_SSC bit field */

/* shiftctl register value */
#define SHIFTCTL_SFS(regval)               (BITS(0,14) & ((regval) << 0))       /*!< write value to RTC_SHIFTCTL_SFS bit field */
...
/* tts register value */
#define TTS_SC(regval)                     (BITS(0,6) & ((regval) << 0))        /*!< write value to RTC_TTS_SC bit field */
#define GET_TTS_SC(regval)                 GET_BITS((regval),0,6)               /*!< get value of RTC_TTS_SC bit field */

#define TTS_MN(regval)                     (BITS(8,14) & ((regval) << 8))       /*!< write value to RTC_TTS_MN bit field */
#define GET_TTS_MN(regval)                 GET_BITS((regval),8,14)              /*!< get value of RTC_TTS_MN bit field */

#define TTS_HR(regval)                     (BITS(16,21) & ((regval) << 16))     /*!< write value to RTC_TTS_HR bit field */
#define GET_TTS_HR(regval)                 GET_BITS((regval),16,21)             /*!< get value of RTC_TTS_HR bit field */

/* dts register value */
#define DTS_DAY(regval)                    (BITS(0,5) & ((regval) << 0))        /*!< write value to RTC_DTS_DAY bit field */
#define GET_DTS_DAY(regval)                GET_BITS((regval),0,5)               /*!< get value of RTC_DTS_DAY bit field */

#define DTS_MON(regval)                    (BITS(8,12) & ((regval) << 8))       /*!< write value to RTC_DTS_MON bit field */
#define GET_DTS_MON(regval)                GET_BITS((regval),8,11)              /*!< get value of RTC_DTS_MON bit field */

#define DTS_DOW(regval)                    (BITS(13,15) & ((regval) << 13))     /*!< write value to RTC_DTS_DOW bit field */
#define GET_DTS_DOW(regval)                GET_BITS((regval),13,15)             /*!< get value of RTC_DTS_DOW bit field */

/* ssts register value */
#define SSTS_SSC(regval)                   (BITS(0,15) & ((regval) << 0))       /*!< write value to RTC_SSTS_SSC bit field */

/* hrfc register value */
#define HRFC_CMSK(regval)                  (BITS(0,8) & ((regval) << 0))        /*!< write value to RTC_HRFC_CMSK bit field */
...
/* tamp register value */
#define TAMP_FREQ(regval)                  (BITS(8,10) & ((regval) << 8))      /*!< write value to RTC_TAMP_FREQ bit field */
...
#define TAMP_FLT(regval)                   (BITS(11,12) & ((regval) << 11))     /*!< write value to RTC_TAMP_FLT bit field */
...
#define TAMP_PRCH(regval)                  (BITS(13,14 ) & ((regval) << 13))    /*!< write value to RTC_TAMP_PRCH bit field */
...
#define RTC_TAMPER_TRIGGER_POS             ((uint32_t)0x00000001)               /* shift position of trigger relative to source */
...
#define ALRM0SS_SSC(regval)                (BITS(0,14) & ((regval)<< 0))        /*!< write value to RTC_ALRM0SS_SSC bit field */

#define ALRM0SS_MASKSSC(regval)            (BITS(24,27) & ((regval) << 24))     /*!< write value to RTC_ALRM0SS_MASKSSC bit field */
...
#define RTC_MASKSSC_8_14                   ALRM0SS_MASKSSC(8)                   /*!< mask RTC_ALRM0SS_SSC[14:7], and RTC_ALRM0SS_SSC[6:0] is to be compared */
...
/* write protect key */
#define RTC_UNLOCK_KEY1                    ((uint8_t)0xCA)                      /*!< RTC unlock key1 */
#define RTC_UNLOCK_KEY2                    ((uint8_t)0x53)                      /*!< RTC unlock key2 */
#define RTC_LOCK_KEY                       ((uint8_t)0xFF)                      /*!< RTC lock key */

/* registers reset value */
#define RTC_REGISTER_RESET                 ((uint32_t)0x00000000)               /*!< RTC common register reset value */
#define RTC_DATE_RESET                     ((uint32_t)0x00002101)               /*!< RTC_DATE register reset value */
#define RTC_STAT_RESET                     ((uint32_t)0x00000007)               /*!< RTC_STAT register reset value */
#define RTC_PSC_RESET                      ((uint32_t)0x007F00FF)               /*!< RTC_PSC register reset value */

/* RTC timeout value */
#define RTC_INITM_TIMEOUT                  ((uint32_t)0x00004000)               /*!< initialization state flag timeout */
#define RTC_RSYNF_TIMEOUT                  ((uint32_t)0x00008000)               /*!< register synchronization flag timeout */
#define RTC_HRFC_TIMEOUT                   ((uint32_t)0x00001000)               /*!< recalibration pending flag timeout */
#define RTC_SHIFTCTL_TIMEOUT               ((uint32_t)0x00001000)               /*!< shift function operation pending flag timeout */
#define RTC_ALRM0WF_TIMEOUT                ((uint32_t)0x00008000)               /*!< alarm configuration can be write flag timeout */
